...
#define ALARM_SHUTDOWN_REQUEST			0x1000
...
#define APP_TASK_SYSTEM_SHUTDOWN_EVENT	0x0020
#define APP_TASK_SYS_RESET_EVENT		0x0040
#define APP_TASK_TEN_SECS_EVENT			0x0080
